            ...
            <tr>
                ...
                <td class="title-cell">
                    <div class="quotation-title-box">
                        <table>
                            <tr>
                                <td style="font-size:18px; font-weight:bold;">Quotation</td>
                                <td class="quotation-number-box">{{ $quotation->client->name }}</td>
                            </tr>
                        </table>
                    </div>
                </td>
        ...
        <table class="address-table">
            <tr>
                ...
                <td class="address-col">
                    ...
                    <p style="font-weight:bold;">{{ $quotation->client->name }}</p>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $quotation->client->name }}</td>
                ...
                @if($quotation->general_discount > 0)
                <tr class="totals-row">
                    <td colspan="5"></td>
                    <td colspan="2" class="text-right">General Discount ({{ $quotation->general_discount }}%):</td>
                    <td class="text-right">- {{ number_format($quotation->general_discount_amount, 2) }}</td>
                </tr>
                <tr class="totals-row">
                    <td colspan="5"></td>
        ...
        <table class="footer-table">
            <tr>
                ...
                <td class="footer-notes">
                    ...
                    <p>Validity period: 15 days from: {{ $quotation->date->format('d/m/Y') }}</p>
                    @if($quotation->notes)
                        <p style="margin-top:5px;">{{ $quotation->notes }}</p>
                    @endif
